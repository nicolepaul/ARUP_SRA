...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        handles.text28b = uicontrol( ...
            ...
            'FontWeight', 'bold', ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Bedrock Information:', ...
            'HorizontalAlignment', 'left');
        
        handles.text28c = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'text28c', ...
            'Style', 'text', ...
            'Units', 'characters', ...
            'Position', ppinv.*[100 21 40 1.2], ...
            'FontAngle', 'oblique', ...
            'FontWeight', 'bold', ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Recorded Information:', ...
            'HorizontalAlignment', 'left');
        ...
        handles.openoutcrop = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'openoutcrop', ...
            'UserData', zeros(1,0), ...
            'Style', 'pushbutton', ...
            'Units', 'characters', ...
            'Position', ppinv.*[80 17.6 10 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Open', ...
            'CData', zeros(1,0), ...
            'Callback', @openoutcrop_Callback);
        ...
        handles.oneplot = uicontrol( ...
            ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Put All Single Column Results on One Plot');
        ...
        handles.outcrop = uicontrol( ...
            ...
            'Position', ppinv.*[54.8 19.2 50 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'Callback', @outcrop_Callback, ...
            'String', 'Use Outcrop');
        
        handles.recsurfa = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'recsurfa', ...
            'Style', 'checkbox', ...
            'Units', 'characters', ...
            'Position', ppinv.*[100 17.6 50 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Recorded Surface Acceleration');
        
        handles.recspecamp = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'recspecamp', ...
            'Style', 'checkbox', ...
            'Units', 'characters', ...
            'Position', ppinv.*[100 19.2 50 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Recorded Spectral Amplification');
        ...
        handles.rsgeomean = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'rsgeomean', ...
            'Style', 'checkbox', ...
            'Units', 'characters', ...
            'Position', ppinv.*[6.4 12.6 50 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'String', 'Geomean');
        ...
        handles.outcropfolder = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'outcropfolder', ...
            'Style', 'edit', ...
            'Units', 'characters', ...
            'Position', ppinv.*[58.5 17.6 20 1.5], ...
            'FontAngle', 'oblique', ...
            'ForegroundColor', [0.502 0.502 0.502], ...
            'BackgroundColor', [1 1 1], ...
            'HorizontalAlignment', 'left', ...
        ...
        handles.outcropunits = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'outcropunits', ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', ppinv.*[58.5 15.8 12 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'String', {'m/s','m/s^2','g'});
        
        handles.recunits = uicontrol( ...
            'Parent', handles.PANELRIGHT, ...
            'Tag', 'recunits', ...
            'Style', 'popupmenu', ...
            'Units', 'characters', ...
            'Position', ppinv.*[103.7 15.8 12 1.5], ...
            'BackgroundColor', [1 1 1], ...
            'String', {'g','m/s^2'});
...
%% ---------------------------------------------------------------------------
    function opendirectory_Callback(hObject,evendata) %#ok<INUSD>
        ...
        N = size(FileList, 1);
        if ~exist(fullfile(datafile,'zPROCESSED_DATA.mat'),'file');
            nfolders = N;
        ...
        % Update outcrop folder directory - assume same as directorystr
        % initially
...
%% ---------------------------------------------------------------------------
    function openoutcrop_Callback(hObject,evendata) %#ok<INUSD>
        ...
        set(handles.outcropfolder,'ForegroundColor','k');
        
        
    end

%% ---------------------------------------------------------------------------
    function outcrop_Callback(hObject,evendata) %#ok<INUSD>
        folderchosen = strcmpi(get(handles.outcropfolder, 'str'),'Choose directory...');
        val = get(handles.outcrop,'Value');
        if val && folderchosen
            set(handles.outcropfolder,'ForegroundColor','r');
        end
